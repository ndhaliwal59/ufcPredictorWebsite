        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 rounded-full bg-[#1E2530] flex items-center justify-center text-[#E0E0E0] hover:text-white transition-colors duration-200"
                aria-label="Twitter"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-[#9CA3AF] hover:text-white transition-colors duration-200">API Documentation</a></li>
              ...
              <li><a href="/how-it-works#faq" className="text-[#9CA3AF] hover:text-white transition-colors duration-200">FAQ</a></li>
            </ul>
          </div>
        </div>
